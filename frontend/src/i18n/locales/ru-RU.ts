...
/example\.(net|org)/`,
  ...
  integrations: {
    ...
    api: {
      ...
      capabilityManageKbsHint: 'Позволяет обновлять или удалять существующие базы знаний и менять их конфигурацию в выбранной области. Не разрешает создавать новые базы знаний.',
  ...
  userProfile: {
    ...
    adminManagement: {
      title: 'Вы — системный администратор',
      description: 'Здесь показаны только данные вашего аккаунта. Чтобы увидеть всех пользователей, редактировать учётные записи, привязывать пользователей к пространствам или управлять их правами, откройте панель управления пользователями.',
      cta: 'Открыть управление пользователями',
    },
  },
  tenantMember: {
    title: 'Участники',
