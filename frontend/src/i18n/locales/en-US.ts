  ...
  system: {
    ...
    globalSettings: {
      ...
      userManagement: {
        ...
        createDialog: {
          title: 'Create user',
          description: 'Use this form to create a user account directly. The account lands in the “unassigned workspace” state by default; a system administrator can assign a workspace later from the Workspaces tab.',
          fields: {
            username: 'Username',
            email: 'Email',
            password: 'Password',
