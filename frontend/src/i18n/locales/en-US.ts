    ...
    globalSettings: {
      ...
      sections: {
        ...
        users: {
          ...
          description: 'Browse every registered user, see which workspaces they belong to and in what role, and adjust account info, reset passwords, or enable/disable accounts when needed.',
        },
        spaces: {
          tab: 'Workspaces',
          title: 'Workspaces',
          description: 'Browse every workspace in the platform, including its default quota and status. System administrators can assign workspaces to new users, or adjust the quota and status of existing ones.',
        },
        other: {
          tab: 'Other {count}',
      ...
      audit: {
        ...
        action: {
          ...
          'system.user_updated': 'User account updated',
          'system.user_created': 'User account created',
          'system.user_deleted': 'User account deleted',
          'system.tenant_created': 'Workspace created',
          'system.tenant_updated': 'Workspace updated',
      ...
      userManagement: {
        ...
        membershipCountOne: '1',
        membershipCountMany: '{count}',
        homeBadge: 'Home',
        actions: {
          view: 'View details',
          edit: 'Edit account',
        ...
        createDialog: {
          title: 'Create user',
          description: 'Use this form to create a user account directly. You can assign a workspace and role here so the new user lands with the right access to content and menus; leave both empty to keep the legacy “unassigned workspace” flow and assign a workspace later from the Workspaces tab.',
          fields: {
            username: 'Username',
            email: 'Email',
            password: 'Password',
        ...
        deleteDialog: {
          ...
          warning: 'This action cannot be undone. All of this user\u2019s workspace memberships will also be removed. Please proceed with caution.',
          confirmHint: 'Please type the user\u2019s email {email} to confirm deletion.',
          confirmPlaceholder: 'Type the user email to confirm',
          submit: 'Confirm delete',
          cancel: 'Cancel',
          success: 'User deleted',
          failed: 'Failed to delete user',
          selfBlocked: 'You cannot delete your own account here — please ask another system administrator.',
        },
        detail: {
          title: 'User details',
        ...
        editDialog: {
          title: 'Edit user',
          description: 'Changes take effect immediately and are written to the audit log. You cannot edit your own account from here.',
          selfBlocked: 'You cannot edit your own account from here — use the profile settings instead.',
          fields: {
            username: 'Username',
            email: 'Email',
            isActive: 'Account status',
        ...
        confirm: {
          activate: {
            ...
            body: 'Enable {name}\u2019s account? They will be able to log in again.',
            confirmBtn: 'Enable',
          },
          deactivate: {
            header: 'Disable account',
            body: 'Disable {name}\u2019s account? They will be unable to log in, and all their active sessions will be invalidated immediately.',
            confirmBtn: 'Disable',
            adminWarning: 'This user is currently a system administrator. Revoke their system-admin role first.',
          },
        },
        passwordDialog: {
          title: 'Reset password for {name}',
          warning: 'All active sessions for this user will be invalidated immediately; they will need to log in with the new password.',
          emailLabel: 'User email',
          newPasswordLabel: 'New password',
          ...
          cancel: 'Cancel',
          success: 'Password reset; existing sessions have been invalidated',
          failed: 'Failed to reset password',
          selfBlocked: 'You cannot reset your own password from here — use the profile settings instead.',
          validation: {
            passwordRequired: 'Please enter a new password',
            passwordLength: 'Password length must be 8-32 characters',
            passwordLetter: 'Password must contain a letter',
            passwordNumber: 'Password must contain a number',
      ...
      spaceManagement: {
        ...
        totalLabel: '{total} workspaces total',
        columns: {
          name: 'Workspace name',
          description: 'Description',
          owner: 'Owner',
        ...
        detail: {
          title: 'Workspace management',
          description: 'Browse every workspace in the platform, assign workspaces to new users, or adjust the quota and status of existing ones.',
          accountSection: 'Workspace information',
          fields: {
            name: 'Workspace name',
            description: 'Description',
            status: 'Status',
          ...
          ownerEmptyHint: 'This workspace has no owner yet.',
        },
        createDialog: {
          title: 'Create workspace',
          description: 'Create a new workspace for a user. By default you become the Owner of this workspace; select a target user below to assign the Owner role to someone else.',
          fields: {
            name: 'Workspace name',
            description: 'Description',
          ...
          namePlaceholder: '1-128 characters',
          descriptionPlaceholder: 'Up to 512 characters',
          storageQuotaPlaceholder: 'Leave blank to use the system default',
          ...
          ownerSelector: {
            title: 'Owner',
            selfOption: 'For your own use',
            placeholder: 'Select an owner',
            loadingError: 'Failed to load the user list — please refresh the page or choose “For your own use”.',
          },
          validation: {
            nameRequired: 'Please enter a workspace name',
            nameLength: 'Name length must be 1-128 characters',
          },
        },
        editDialog: {
        ...
        deleteDialog: {
          ...
          warning: 'This action cannot be undone. All memberships will also be removed. If you are the Owner of this workspace and have no other workspaces, deletion will be refused.',
          confirmHint: 'Please type the workspace ID {id} to confirm deletion.',
          confirmPlaceholder: 'Type the workspace ID to confirm',
          submit: 'Confirm delete',
          cancel: 'Cancel',
          success: 'Workspace deleted',
          failed: 'Failed to delete workspace',
        ...
        messages: {
          ...
          detailLoadFailed: 'Failed to load workspace details',
        },
        actions: {
          view: 'View details',
          edit: 'Edit workspace',
