    ...
    globalSettings: {
      ...
      sections: {
        ...
        spaces: {
          tab: "空间管理",
          title: "空间管理",
          description: "查看平台中所有空间，包括默认配额与状态。系统管理员可以为新用户分配空间，或调整现有空间的配额与状态。",
        },
        other: {
          tab: "其他 {count}",
          title: "其他配置",
      ...
      audit: {
        ...
        action: {
          ...
          "system.user_updated": "修改用户账户",
          "system.user_created": "创建用户账户",
          "system.user_deleted": "删除用户账户",
          "system.tenant_created": "创建空间",
          "system.tenant_updated": "更新空间",
          "system.tenant_deleted": "删除空间",
      ...
      userManagement: {
        ...
        membershipCount: "{count} 个",
        membershipCountOne: "1 个",
        membershipCountMany: "{count} 个",
        homeBadge: "主空间",
        actions: {
          view: "查看详情",
          edit: "编辑账户",
        ...
        createDialog: {
          title: "新建用户",
          description: "使用此表单直接创建一个用户账户。可以在此处同时为其分配一个空间与角色，以便立即限制其可访问的内容与菜单；留空则账户进入\"未分配空间\"状态，稍后从空间管理页面分配。",
          fields: {
            username: "用户名",
            email: "邮箱",
            password: "密码",
        ...
        deleteDialog: {
          title: "删除用户 {name}",
          warning: "该操作不可撤销，将同时清除该用户的所有空间成员关系。请谨慎操作。",
          confirmHint: "请输入该用户的邮箱 {email} 以确认删除。",
          confirmPlaceholder: "输入用户邮箱以确认",
          submit: "确认删除",
          cancel: "取消",
          success: "用户已删除",
          failed: "删除用户失败",
          selfBlocked: "不能在这里删除自己的账户，请联系另一位系统管理员。",
        },
        detail: {
          title: "用户详情",
        ...
        editDialog: {
          title: "编辑用户",
          description: "修改后会立即生效，并写入审计日志；此处不能编辑自己的账户。",
          selfBlocked: "不能在这里编辑自己的账户，请前往个人资料。",
          fields: {
            username: "用户名",
            email: "邮箱",
            isActive: "账号状态",
        ...
        confirm: {
          activate: {
            header: "启用账号",
            body: "确认启用 {name} 的账号？启用后该用户可以重新登录。",
            confirmBtn: "确认启用",
          },
          deactivate: {
            header: "停用账号",
            body: "确认停用 {name} 的账号？停用后该用户将无法登录，所有会话立即失效。",
            confirmBtn: "确认停用",
            adminWarning: "该用户当前是系统管理员；停用前请先撤销其系统管理员权限。",
          },
        },
        passwordDialog: {
          title: "重置 {name} 的密码",
          warning: "重置成功后该用户的所有登录会话会立即失效，需要使用新密码重新登录。",
          emailLabel: "用户邮箱",
          newPasswordLabel: "新密码",
          newPasswordPlaceholder: "8-32 个字符，包含字母和数字",
          confirmPasswordLabel: "确认新密码",
          ...
          success: "密码已重置，该用户的现有会话已失效",
          failed: "重置密码失败",
          selfBlocked: "不能在这里重置自己的密码，请前往个人资料。",
          validation: {
            passwordRequired: "请输入新密码",
            passwordLength: "密码长度必须为 8-32 个字符",
            passwordLetter: "密码必须包含字母",
      ...
      spaceManagement: {
        ...
        memberCountLabel: "{count} 人",
        detail: {
          title: "空间管理",
          description: "查看平台中所有空间，并为新用户分配空间，或调整现有空间的配额与状态。",
          accountSection: "空间信息",
          fields: {
            name: "空间名称",
            description: "描述",
          ...
          ownerEmptyHint: "该空间暂无所有者",
        },
        createDialog: {
          title: "新建空间",
          description: "为某个用户创建一个新的工作区。默认状态下，你自己是该空间的所有者；如需为其他用户分配空间，请在下方选择目标用户。",
          fields: {
            name: "空间名称",
            description: "描述",
          ...
          namePlaceholder: "1-128 个字符",
          descriptionPlaceholder: "最多 512 个字符",
          storageQuotaPlaceholder: "留空则使用系统默认配额",
          submit: "创建空间",
          cancel: "取消",
          success: "空间已创建",
          failed: "创建空间失败",
          ownerSelector: {
            ...
            selfOption: "管理员自用",
            placeholder: "选择所有者",
            loadingError: "加载用户列表失败，请刷新页面或选择“管理员自用”。",
          },
          validation: {
            nameRequired: "请输入空间名称",
            nameLength: "名称长度必须为 1-128 个字符",
          },
        },
        editDialog: {
          title: "编辑空间 {name}",
        ...
        deleteDialog: {
          title: "删除空间 {name}",
          warning: "该操作不可撤销，会同时清除所有成员关系。如果你是该空间的所有者，且没有其他可用空间，删除将被拒绝。",
          confirmHint: "请输入该空间的 ID {id} 以确认删除。",
          confirmPlaceholder: "输入空间 ID 以确认",
          submit: "确认删除",
          cancel: "取消",
          success: "空间已删除",
          failed: "删除空间失败",
