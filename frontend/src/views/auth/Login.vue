<template>
  <div class="login-layout">
    ...
    <!-- Logo - Top Left -->
    <div class="header-logo" :title="BRAND_NAME">
      <span class="brand-text">{{ BRAND_NAME }}</span>
    </div>

    <!-- Header Links - Top Right -->
    <div class="header-links">
      <a v-if="SHOW_OFFICIAL_LINK" :href="BRAND_OFFICIAL_URL" target="_blank" class="header-link" :title="$t('common.website')">
      ...
      <a v-if="SHOW_GITHUB_LINK" :href="BRAND_GITHUB_URL" target="_blank" class="header-link" :title="$t('common.info')">
